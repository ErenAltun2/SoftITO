# SOFTİTO Eğitimi — Çalışma Deposu

Bu repository, **SOFTİTO** eğitimi kapsamında öğrendiğim konuların günlük olarak düzenlenmiş uygulama dosyalarını içerir. Her klasör, o gün işlenen konuyu ve yaptığım alıştırma/case çözümlerini barındırır.
...
| Klasör | Konu | Özet |
|---|---|---|
| [`VeriTabanı/14-Eylul-SQL`](./VeriTabanı/14EylulSQL) | SQL'e Giriş | Tablo oluşturma, CRUD işlemleri (INSERT/SELECT/UPDATE/DELETE), `ALTER TABLE`, `LIKE`, `BETWEEN`, sıralama ve limitleme |
| [`VeriTabanı/15-Eylul-SQL`](./VeriTabanı/15EylulSQL) | İleri Seviye SQL | Kısıtlar (`CHECK`, `UNIQUE`, `FOREIGN KEY`), `JOIN` türleri, `GROUP BY`/`HAVING`, alt sorgular, `CASE WHEN`, `INDEX` |
...
---
*Bu depo, SOFTİTO eğitimi sürecindeki kişisel çalışmaları ve ders notlarını içerir.*
